<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="com.database.DbConnection,java.sql.*,javax.swing.*" %>
	...
	<!--start-header-->
			<div id="home" class="header">
					<div class="top-header">
						<div class="container">
							<div class="logo" style="logo-align:left">
								<a href="index.jsp"><img align="left" src="images/logoFIC.png" height="150px" alt=""></a>  
